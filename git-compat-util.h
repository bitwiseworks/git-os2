...
extern NORETURN void usagef(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
extern NORETURN void die(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
