...
NORETURN void usagef(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
NORETURN void die(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
NORETURN void die_errno(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
int die_message(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
int die_message_errno(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
int error(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
int error_errno(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
void warning(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
void warning_errno(const char *err, ...) __attribute__((__format__ (__printf__, 1, 2)));
